...
class Auth
{
     ...
     */
    public function __construct(string $appId, string $appSecret, string $baseUrl = 'https://open.feishu.cn/open-apis', ?HttpTransport $transport = null)
    {
        $this->appId = $appId;
    ...
    /**
     * getTenantAccessToken 获取 tenant_access_token（带进程内缓存）
     * @return string
     */
